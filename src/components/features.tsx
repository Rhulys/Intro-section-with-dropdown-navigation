  ...
  return (
    <div className="flex flex-col relative">
      <li
        ...
        className="flex flex-row gap-3 items-center font-semibold text-xl md:text-lg cursor-pointer text-Medium-Gray hover:text-Almost-Black"
      >
        Features
        {openOrCloseFeatures ? (
      ...
      {openOrCloseFeatures && (
        <div className="flex flex-col gap-3 p-8 xl:bg-white xl:rounded-xl xl:shadow-2xl xl:absolute xl:top-12 xl:-left-20">
          <a
            href="#"
            className="flex flex-row gap-3 items-center text-lg font-medium text-Medium-Gray"
          >
